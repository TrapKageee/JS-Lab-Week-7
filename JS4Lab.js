...
let myName = 'Fred'
let friendsName = 'Hank'  
//Question: Name a reason why you would use const instead of let.
//Answer: You would use const instead of let if you wanted a value to remain constant and never change.
 ...
 * ↓ YOUR CODE HERE ↓ */
console.log(
   `${friendsName} and ${myName} are eating ${food} and drinking ${drink} for lunch.`  
)
...
//Answer: 'My friend ' + friendsName + 'and ' + myName + ' are eating ' + food + ' and drinking ' + drink
console.log(`-------------------------- 
Question 2a: Oh no`)
...
//Answer: You can't change a variable used with const
...
const lunchTime = (foodChoice, drinkChoice) => {
   return `${friendsName} and ${myName} are eating ${food} and drinking ${drink} for lunch.`
}
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
const foodForTodayAndTomorrow(tomorrowsFoodChoice, tomorrowsDrinkChoice, and callbackFunction) {
   return `${callbackFunction} Tomorrow we want ${tomorrowsFoodChoice} and ${tomorrowsDrinkChoice}.`
}

console.log(foodForTodayAndTomorrow('Burgers', 'Pop', lunchTime('Chips', 'Fruit Punch')))
